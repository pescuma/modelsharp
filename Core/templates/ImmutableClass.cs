...
namespace org.pescuma.ModelSharp.Core.templates
{
 ...
 ForEach("Param", it.NonComputedProperties, separator: ", "); 
 	...
 	if (it.Cloneable) { 
            ...
            #line 38 "X:\c#\modelsharp\Core\templates\ImmutableClass.tt"
		if (it.Extends != null) { 
            ...
            #line 42 "X:\c#\modelsharp\Core\templates\ImmutableClass.tt"
 	ForEach("ImmutableOtherToField", it.Properties); 
            ...
            #line 45 "X:\c#\modelsharp\Core\templates\ImmutableClass.tt"
 	} 
