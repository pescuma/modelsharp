...
java -jar trang.jar "collection\model.xml" "composition\model.xml" "immutable\model.xml" "implements\model.xml" "lazy\model.xml" "noNamespace\model.xml" "noncloneable\model.xml" "nonserializable\model.xml"  "privateSetter\model.xml" "projectNamespace\model.xml" "required\model.xml" "simple\model.xml" "using\model.xml" "computed-property\model.xml" "doc\model.xml" model_xml.xsd
