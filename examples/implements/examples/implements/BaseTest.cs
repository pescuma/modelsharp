...
namespace examples.implements
{
	...
	public abstract class BaseTest : IList, ICollection, INotifyPropertyChanging, INotifyChildPropertyChanging, INotifyPropertyChanged, INotifyChildPropertyChanged, ICloneable
	{
